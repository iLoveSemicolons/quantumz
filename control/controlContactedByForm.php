...
<h2>
    C'est un site web vitrine uniquement pour vous montrer ce project, donc le formulaire de contact ne fonctionne pas car il n'y tous saimplemant pas connecté à une base de donnée, donc il ne stockera pas vos information, cependant, is vous souhaitez vraiment me contacter allez sur mon site web personnel :)
